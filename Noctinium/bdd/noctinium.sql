...
CREATE TABLE IF NOT EXISTS `noctinium`.`event` (
  ...
  INDEX `fk_event_user1_idx` (`event_user_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `noctinium`.`image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `noctinium`.`image` ;

CREATE TABLE IF NOT EXISTS `noctinium`.`image` (
  `image_id` INT NOT NULL AUTO_INCREMENT,
  `image_url` VARCHAR(70) NOT NULL,
  `image_event_id` INT NULL,
  PRIMARY KEY (`image_id`),
  INDEX `fk_image_event1_idx` (`image_event_id` ASC) VISIBLE,
  CONSTRAINT `fk_image_event1`
    FOREIGN KEY (`image_event_id`)
...
CREATE TABLE IF NOT EXISTS `noctinium`.`user` (
  ...
  UNIQUE INDEX `user_telephone_UNIQUE` (`user_telephone` ASC) VISIBLE,
  INDEX `fk_user_image1_idx` (`user_image_id` ASC) VISIBLE,
  CONSTRAINT `fk_user_image1`
    FOREIGN KEY (`user_image_id`)
    REFERENCES `noctinium`.`image` (`image_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `noctinium`.`commentevent` (
  ...
  INDEX `fk_comment_user1_idx` (`commentevent_user_id` ASC) VISIBLE,
  INDEX `fk_comment_event1_idx` (`commentevent_event_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `noctinium`.`rating` (
  ...
  INDEX `fk_rating_user1_idx` (`rating_user_id` ASC) VISIBLE,
  INDEX `fk_rating_user2_idx` (`rating_organiser_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `noctinium`.`commentorganiser` (
  ...
  INDEX `fk_comment_user1_idx` (`commentorganiser_user_id` ASC) VISIBLE,
  INDEX `fk_commentorganiser_user1_idx` (`commentorganiser_organiser_id` ASC) VISIBLE,
