...
$server   = '459gv.myd.infomaniak.com';             // Server the database is on
$db       = '459gv_noctinium';             // Name of the database
$port     = '';                      // Port is usually 8889 in MAMP and 3306 in XAMPP
$charset  = 'utf8mb4';               // UTF-8 encoding using 4 bytes of data per character

$username = '459gv_noctinium';         // Enter YOUR username here
$password = 'afRvwkeR43';         // Enter YOUR password here
